...
def has_recent_funding_round(funding_details):
    ...
    last_round = funding_details.last_round
    date = last_round.date
    if not date:
        return False

    last_round_date = datetime.strptime(date, "%Y-%m-%d")
...
|---:|:-------------|:-------------|:-----------------------------------------|:----------------------|:---------------|:-------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  0 | **Redacted** | **Redacted** | San Francisco, California, United States | Head of Team Platform | Mercor         | https://www.linkedin.com/company/mercor-ai | [{'title': 'Head of Team Platform', 'company_name': 'Mercor', 'start_date': '2024-01-01', 'end_date': None}, {'title': 'Head of Mobile Engineering', 'company_name': 'POSH', 'start_date': '2021-03-01', 'end_date': '2021-12-01'}] |
```
